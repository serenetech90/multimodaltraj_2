...
def train(args):
    ...
    with tf.Session(graph=out_graph).as_default() as out_sess:
        ...
        for l in {args.leaveDataset}:
            ...
            for d in datasets:  # range(2,5):
                ...
                log_dir = '/home/siri0005/Documents/multimodaltraj_2/log/g2k_Attn_error_log_kfold_{0}.csv'.format(
                    d)
                log_dir_fde = '/home/siri0005/Documents/multimodaltraj_2/log/g2k_Attn_fde_log_kfold_{0}.csv'.format(
                    d)
                        ...
                        # if e == 0:
                                    ...
                                    sess.run([krnl_mdl.pred_path_band, krnl_mdl.hidden_states, krnl_mdl.cost],
                                             ...
                                             feed_dict={
                                                 krnl_mdl.outputs: np.concatenate(
                                                     (st_embeddings, vislet_emb.eval()), axis=0),
                                                 krnl_mdl.ngh: reg_ng,
                            ...
                            if (e * dataloader.num_batches + b) % args.save_every == 0: #e % args.save_every == 0 and
                                ...
                                checkpoint_path = os.path.join('/home/siri0005/Documents/multimodaltraj_2/save', \
                                                               'g2k_Attn_model_kfold_train_{1}_{0}_{2}.ckpt'.format(e, d, b))
    ...
    with tf.Session(graph=tf_graph) as val_sess:
        ...
        checkpoint_path = os.path.join('/home/siri0005/Documents/multimodaltraj_2/save',
                                       'g2k_Attn_kfold_val_{0}.ckpt'.format(l))
